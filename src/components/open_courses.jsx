...
const OpenCourses = () => {
  ...
  useEffect(() => {
    const fetchCourses = async () => {
      ...
      try {
        const response = await fetch(`https://aims-fgev.onrender.com/api/courses`); // Endpoint for courses
  ...
  useEffect(() => {
      ...
      const fetchStudentDetails = async () => {
        try {
          const response = await fetch(`https://aims-fgev.onrender.com/api/student/student-details`, {
            method: "GET",
            headers: {
  ...
  const handleEnroll = async (courseId) => {
    ...
    const response = await fetch(`https://aims-fgev.onrender.com/api/courses/enroll`, {
      method: "POST",
