...
const ApproveCourses = () => {
  ...
  useEffect(() => {
    const fetchApprovalRequests = async () => {
      ...
      try {
        const response = await fetch(`https://aims-fgev.onrender.com/api/faculty/approval-requests`, {
  ...
  const handleApproval = async (id, role, approve) => {
    try {
      const endpoint =
        role === "instructor"
          ? `https://aims-fgev.onrender.com/api/faculty/approve-instructor`
          : `https://aims-fgev.onrender.com/api/faculty/approve-advisor`;
